...
public void loginAndSearch() {
		...
		try {
			...
			WebElement select_vendor = vendor_dropdown.findElement(By.xpath("//label[text()='Vendor']/preceding-sibling::div/ul/li[2]/span"));
			Actions act= new Actions(driver);
			act.moveToElement(select_vendor).click().build().perform();
			 Thread.sleep(3000);
